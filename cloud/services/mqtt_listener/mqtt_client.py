...
class MQTTDatabaseUpdater:
    ...
    def query_model_service(self, station_id: str, sensor_data: Dict[str, Any],forecast_data: Dict[str, Any], model_name: str) -> str:
        payload = {
            "model": model_name,
                    ...
                    try:
                        ...
                        if merged_sensor_data:
                            for model_name in model_names:
                                summary = self.query_model_service(station_id, {**merged_sensor_data, "timestamp": get_current_timestamp()},tomorrow_forecasts, model_name)
                                if summary:
