...
// ATOMIC PortABC Extension Base — Port C (UART1) = Soil SEN0600, 8N1
...
void setup() {
  ...
  // --- BAKED-IN CONFIG: values below are patched directly into the compiled
  // .bin by the web flasher tool. Buffer sizes MUST match js/patch-esp32-bin.js
  // maxLen values exactly — don't resize without updating both places.
  char cfg_id[48]              = "IOTWXID__PLACEHOLDER_000000000000000000000000";
  char cfg_wifi_ssid[48]       = "IOTWXSSID_PLACEHOLDER_00000000000000000000000";
  char cfg_wifi_pwd[64]        = "IOTWXPWD__PLACEHOLDER_0000000000000000000000000000000000000000";
  char cfg_mq_ip[64]           = "IOTWXMQIP__PLACEHOLDER_000000000000000000000000000000000000000";
  char cfg_topic[96]           = "IOTWXTOPIC_PLACEHOLDER_0000000000000000000000000000000000000000000000000000";
  char cfg_mq_port[8]          = "1883\0\0\0";
  char cfg_gpio_config[4]      = "A\0\0";
  char cfg_use_wifi[4]         = "1\0\0";
  char cfg_publish_interval[8] = "2\0\0\0\0\0\0";
  char cfg_reset_interval[8]   = "360\0\0\0\0";
  char cfg_timezone[8]         = "21600\0\0";
  char cfg_max_frequency[4]    = "80\0";
  char cfg_aspiration_time[4]  = "10\0";
  char cfg_sensor[32]          = "grove/i2c";

  char json_buf[640];
  snprintf(json_buf, sizeof(json_buf),
    "{\"iotwx_gpio_config\":\"%s\",\"iotwx_use_wifi\":\"%s\","
    "\"iotwx_local_config\":\"1\",\"iotwx_id\":\"%s\","
    "\"iotwx_mq_ip\":\"%s\",\"iotwx_mq_port\":\"%s\","
    "\"iotwx_publish_interval\":\"%s\",\"iotwx_reset_interval\":\"%s\","
    "\"iotwx_sensor\":\"%s\",\"iotwx_timezone\":\"%s\","
    "\"iotwx_wifi_pwd\":\"%s\",\"iotwx_wifi_ssid\":\"%s\","
    "\"iotwx_topic\":\"%s\",\"iotwx_max_frequency\":\"%s\","
    "\"iotwx_aspiration_spinup_time\":\"%s\"}",
    cfg_gpio_config, cfg_use_wifi, cfg_id, cfg_mq_ip, cfg_mq_port,
    cfg_publish_interval, cfg_reset_interval, cfg_sensor, cfg_timezone,
    cfg_wifi_pwd, cfg_wifi_ssid, cfg_topic, cfg_max_frequency, cfg_aspiration_time);
